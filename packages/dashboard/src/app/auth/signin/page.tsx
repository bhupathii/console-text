        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-8">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            ...
            <div className="text-left text-xs text-yellow-700">
              <p className="font-medium mb-2">Required for authentication:</p>
              <ul className="space-y-1 list-disc list-inside">
                <li><code className="bg-yellow-100 px-1 rounded">GOOGLE_CLIENT_ID</code></li>
                <li><code className="bg-yellow-100 px-1 rounded">GOOGLE_CLIENT_SECRET</code></li>
                <li><code className="bg-yellow-100 px-1 rounded">NEXTAUTH_SECRET</code></li>
                <li><code className="bg-yellow-100 px-1 rounded">NEXTAUTH_URL</code></li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <h3 className="font-semibold text-gray-900 text-sm">What you'll get after setup:</h3>
          ...
          <button
            disabled
            className="w-full bg-gray-200 border-2 border-gray-200 
                     text-gray-500 font-semibold py-3 px-4 rounded-xl 
